...
public class ConsultarAluno extends JFrame {
    ...
    public ConsultarAluno(String matr) // Contrutor
    {
        initComponents(matr);
    }
    
    private void initComponents(String matr) // Componentes do Contrutor
    {
        ...
        btnNota = new JButton("Lancar Nota");
        ...
        btnNota.setBounds(50,heigth - 100 - 50,360,100);
        btnNota.setFont(title);
        btnNota.setBackground(bg1);
        btnNota.setForeground(fg1);
        
        btnConsulta.setBounds(540, heigth - 100 - 50, 360, 100);
        btnConsulta.setFont(title);
        btnConsulta.setBackground(bg1);
        btnConsulta.setForeground(fg1);
